(function (e) {
    ...
    }, w = {clickToHide: !0, autoHide: !0, autoHideDelay: 5e3, arrowShow: !0, arrowSize: 5, breakNewLines: !0, elementPosition: "bottom", globalPosition: "bottom center", style: "bootstrap", className: "error", showAnimation: "slideDown", showDuration: 400, hideAnimation: "slideUp", hideDuration: 200, gap: 5}, E = function (t, n) {
        var r;
        return r = function () {
    ...
    }, e.extend(e[n], {defaults: S, addStyle: m, removeStyle: v, pluginOptions: w, getStyle: d, insertCSS: g}), m("bootstrap", {html: "<div>\n<span data-notify-text></span>\n</div>", classes: {base: {"box-shadow": "0 10px 15px 0 #aaa", "width" : "auto", "height" : "auto", color: "#fff", "background-color": "#333", "border-radius": "2px", "padding": "15px"}, error: {"background-color": "#da0000"}, success: {"background-color": "#0e8442"}, info: {"background-color": "#3b3d3e"}, warn: {"background-color": "#d08202"}}}), e(function () {
